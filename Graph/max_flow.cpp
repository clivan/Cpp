...
public:
  ...
  void print_flow_info()
  {
    ...
    std::cout<<"Nodes: "<<total_nodes<<std::endl<<"Max flow: "<<max_flow<<std::endl<<"Edge present in flow: "<<edge_participated.size()<<std::endl;
    std::cout<<"Source\tDestination\tCapacity\tTotal_nodes"<<std::endl;
